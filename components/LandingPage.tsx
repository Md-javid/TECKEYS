        ...
        <div className="relative min-h-screen flex flex-col overflow-hidden">
            ...
            <nav className="relative z-10 px-6 py-6 flex justify-between items-center max-w-7xl mx-auto w-full">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button
                        ...
                        className="group px-5 py-2.5 bg-white text-black rounded-full text-sm font-semibold hover:bg-blue-50 transition-all flex items-center gap-2 shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)]"
                    >
            ...
            <main className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 py-20">
                <div className="max-w-4xl mx-auto space-y-8 animate-fade-in-up">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-sm font-medium text-blue-400 backdrop-blur-sm mb-4">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                        ...
                        <button className="w-full sm:w-auto px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-2xl font-semibold text-lg transition-all backdrop-blur-sm">
                            Watch Demo
                        </button>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-16 text-left">
                        <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-colors group">
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">Instant OCR</h3>
                            <p className="text-white/50">Upload any bill format and extract data in seconds with 99% accuracy.</p>
                        </div>
                        <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-colors group">
                            ...
                            <p className="text-white/50">Visualize spending patterns and get AI-driven cost saving suggestions.</p>
                        </div>
                        <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-colors group">
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">Bank Assessment</h3>
                            <p className="text-white/50">Enterprise-grade security ensures your financial data is always protected.</p>
                        </div>
                    </div>
                </div>
            </main>
            ...
            {/* Footer minimal */}
            <footer className="relative z-10 py-6 text-center text-white/30 text-sm">
